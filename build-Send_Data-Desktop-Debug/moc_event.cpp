...
const QMetaObjectExtraData Event::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Event::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Event,
      qt_meta_data_Event, &staticMetaObjectExtraData }
};
