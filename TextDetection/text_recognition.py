...
if s:    
    ...
    cv2.imwrite("images/filename.jpg",img) #save image
"""
...
ap.add_argument("-i", "--image", type=str, default="/home/student/Desktop/Code_github/TextDetection/images/filename3.jpg",
    help="path to input image")
ap.add_argument("-east", "--east", type=str, default="/home/student/Desktop/Code_github/TextDetection/frozen_east_text_detection.pb",
...
for ((startX, startY, endX, endY), text) in results:
    ...
    print(confidences[0])
    f.write(text)
    gemiddelde = gemiddelde + confidences[0]
    total = total + 1
