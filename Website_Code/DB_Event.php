...
<table style="border: 1px solid white;">
    <tr>
        ...
        <th style="border: 1px solid white;">AantalMensen</th>
    </tr>
    <tbody id="data"></tbody>
</table>
    ...
    ajax.onreadystatechange = function ()
    {
        if (this.readyState == 4 && this.status == 200)
        {
            ...
            for (var i = 0; i < data.length; i++)
            {
                ...
                html += "<td style='font-weight: normal;'>" + data[i].TIME + "</td>";
                html += "<td style='font-weight: normal;'>" + data[i].AantalMensen + "</td>";
                html += "</tr>";
            }
